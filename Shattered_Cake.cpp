...
of the cake is known. The restaurant asks for your help to find out the length L

of the cake. Fortunately, all pieces of the shattered cake have been kept.
Input

The input consists of the following integers:

    on the first line, the width W

of the cake;

on the second line, the number N

of shattered pieces;

on each of the next N
lines, the width wi and length li
