...
, indicates the number of eye designs. The second, T, indicates the number of nose designs. The third, M, indicates the number of mouth designs. All three values are in the range [1,500]
